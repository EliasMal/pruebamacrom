...
<body ng-app="RptsuruVolks">
    <div class="container mt-3" ng-controller="ComprobantePagoCtrl">
        <div class="row">
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                 <img class="rounded mx-auto d-block" src="https://macromautopartes.com/images/icons/logomacrom.png">
            </div>
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                <h1 class="text-center text-danger">PAGADA</h1>
            </div>
        </div>

        <div class="row mt-3">
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                <h3>Pedido: <span class="text-danger">#{{Comprobante.noPedido}}</span></h3>
            </div>
        </div>
        <hr>
        <div class="row">
