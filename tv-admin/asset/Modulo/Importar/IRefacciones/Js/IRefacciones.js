var url = "./Modulo/Importar/IRefacciones/Ajax/IRefacciones.php";

tsuruVolks
        .controller('IRefaccionesCtrl', ["$scope","$http",IRefaccionesCtrl]);

function IRefaccionesCtrl($scope,$http){
    var obj  = $scope;
    obj.archivo = {
        ...
        $(".archivos").on("change",function(e){
            ...
            if(file){
                if(file.size <= 5120000){
                    ...
                    toastr.warning("Error el Archivo supera los 1 MB");
                    return;
                }
            }else{
                return;
